...
| **NAME** |**WORK**|
|----------|--------|
|**AFIF RIFQI BIN SHAIFUL REZAL** |7.0 - 7.4 -> Project Planning|
|**AMAL HIJAZ BIN ABD WAHID**|4.2 -> Feasibility Study <br> 6.0 - 6.2 -> Scope of the Project|
| **ADAM FAHIM MOHD FOAD**|4.1 -> System Overview <br> 5.0 -> Objectives|
|**AMREISH A/L UMAPATHY**|1.0 -> Introduction <br> 2.0 -> Background Study|
|**ADAM BIN BAHARUDDIN**|8.0 - 8.2 -> Benefits and Overall Summary|
